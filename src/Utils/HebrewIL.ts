...
const heILGrid: Partial<any> = {
  ...
  toolbarExportCSV: 'ייצוא ל- Excel',
  ...
  groupColumn: (name: any) => `קבץ לפי ${name}`,
  unGroupColumn: (name: any) => `הפסק לקבץ לפי ${name}`,
